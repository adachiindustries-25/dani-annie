...
# PAGE 3 - MEMORIES
    ...
    memory_slot(
        "first_sleepover",
        "First Sleepover",
        "When things got comfortable. Not trying to impress anyone, not overthinking anything, just easy as fuckkkk."
    )
    ...
    memory_slot(
        "recent",
        "More Recent Ones",
        "The later ones. A bit more bittersweet maybe, but still worth keeping to me :) ."
    )
...
# PAGE 4 - SMALL MOMENTS
    ...
    body(
        ...
        "the ones you actually think about you get me?."
    )
